...
const state: BuilderState = {
  ...
  revision: 0,
  lines: [
    { key: "a", productId: "p1", title: "Full Decontamination & Body Polish", description: "", qty: 1, unitCents: 3200000, discountPct: 0, vatRatePct: 15 },
    { key: "b", productId: "p2", title: "Remove Wheel, Decontamination & Polish", description: "", qty: 4, unitCents: 380000, discountPct: 0, vatRatePct: 15 },
